...
async function main() {
  const victor = await prisma.author.upsert({
    where: { username: "sebinha" },
    update: {},
    create: {
      name: "Victor Fernandes",
      username: "sebinha",
      avatar:
        "https://avatars.githubusercontent.com/u/52221836?v=4",
    },
  });

  console.log(`Author ${victor.username} upserted`);
  ...
  console.log(`${posts.length} posts upserteds`);
